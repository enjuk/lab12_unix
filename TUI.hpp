...
namespace tui
{
   ...
   // ==== clearScreen ===========================================================
   // This function outputs the ANSI escape codes necessary to clear the terminal
   // in unix systems.
   //
   // Input:
   //  None
   ...
   inline void clearScreen()
   {
      ...
      // ==== pauseProgram ==========================================================
      // This function uses the appropriate unix system call to halt the program
      // and display a message to a user that they need to press a key to continue
      // execution.
      //
      // Input:
      //  None
      //
      // Output:
      //  A message is displayed to the user telling them to press a key to continue.
      // ============================================================================
